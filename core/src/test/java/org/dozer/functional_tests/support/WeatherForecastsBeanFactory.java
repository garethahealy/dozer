...
public class WeatherForecastsBeanFactory extends BaseSampleBeanFactory {

    public Object createBean(Object srcObj, Class<?> srcObjClass, String id) {
        WeatherForecasts rvalue = WeatherForecasts.Factory.newInstance();

        // just for unit testing. need something to indicate that it was created by the factory method
        setCreatedByFactoryName(rvalue, WeatherForecastsBeanFactory.class.getName());
